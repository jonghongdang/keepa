...
export default function Header() {
    ...
    return <div className="flex topPanel unselectable px-[20px]" id="topPanel">
        ...
        <div id="subPanel" className="subPanel unselectable" style={{ marginTop: "80px", background: "linear-gradient(rgba(147, 84, 73, 0.8) 0px, rgba(255, 74, 74, 0.6) 100%) rgba(0, 0, 0, 0.27)" }}>
            ...
            <ul className="subMenu" rel="addon" style={{ display: "none" }}>
                <li>
            ...
            <ul className="subMenu" rel="data" style={{ display: "none" }}>
                <li>
            ...
            <ul className="subMenu" rel="features" style={{ display: "none" }}>
                <li>
